...
**2. 京都市内エリアの判定基準 (Regional Percentiles)**
常に人が多い京都市内（北緯34.85-35.12, 東経135.55-135.90）では、過剰な混雑判定を防ぐため、以下の独自基準（パーセンタイル）を採用しています。

| レベル | 混雑度 | 対象パーセンタイル | 割合 |
| :--- | :--- | :--- | :--- |
| **Level 1** | 快適 | **0% 〜 30%** | 下位 30% |
| **Level 2** | やや快適 | **30% 〜 55%** | 次の 25% |
| **Level 3** | 通常 | **55% 〜 75%** | 次の 20% |
| **Level 4** | やや混雑 | **75% 〜 92%** | 次の 17% |
| **Level 5** | **混雑** | **92% 〜 100%** | **上位 8%** |
